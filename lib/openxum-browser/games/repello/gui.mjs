...
let cpt_r = 17;let cpt_b = 16; //temp
...
class Gui extends OpenXum.Gui {
    ...
    _draw_reserve (Color){
        ...
        if (cpt_r <16 ) {
            ...
            //this._context.fillText(cpt_r.toString(), this._offsetX + 0.20 * this._deltaX, this._offsetY + (-0.75) * this._deltaY);
            //this._context.fillText(cpt_b.toString(), this._offsetX + 0.20 * this._deltaX, this._offsetY + (13.15) * this._deltaY);
            this._context.fillStyle = "#000000";
            ...
            for (let i = 0; i < cpt_b; ++i) {
                this._context.beginPath();
                this._context.rect(60 + i * 10, 488, 5, 15);
                this._context.closePath();
                this._context.stroke();
                this._context.fill();
            }
