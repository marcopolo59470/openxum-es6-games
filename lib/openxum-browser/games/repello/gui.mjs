    ...
    _draw_reserve (){
        ...
        for (let a=1;a < tab.length;a+=2){
            ...
            if (tab[a]===-1) {
                ...
                switch (tab[a - 1]) {
                    case 1:
                        this._draw_piece(this._deltaY * 0.5, this._offsetX + ((a*0.35) +0.15) * this._deltaY, 'bronze');
                        break;
                    case 3:
                        this._draw_piece(this._deltaY * 0.5, this._offsetX + ((a*0.35) +0.15) * this._deltaY, 'argent');
                        break;
                    case 5:
                        this._draw_piece(this._deltaY * 0.5, this._offsetX + ((a*0.35) +0.15) * this._deltaY, 'or');
                        break;
                }
            }else{
                switch (tab[a - 1]) {
                    case 1:
                        this._draw_piece(this._offsetX + 13.4 * this._deltaX, 15.5*this._offsetX-(this._offsetX + ((a*0.35) +0.15) * this._deltaY), 'bronze');
                        break;
                    case 3:
                        this._draw_piece(this._offsetX + 13.4 * this._deltaX, 15.5*this._offsetX-(this._offsetX + ((a*0.35) +0.15) * this._deltaY), 'argent');
                        break;
                    case 5:
                        this._draw_piece(this._offsetX + 13.4 * this._deltaX, 15.5*this._offsetX-(this._offsetX + ((a*0.35) +0.15) * this._deltaY), 'or');
                        break;
                }
            }
        }
