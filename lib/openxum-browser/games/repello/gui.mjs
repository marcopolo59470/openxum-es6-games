...
class Gui extends OpenXum.Gui {
  ...
  _on_click(x, y) {
    if (nb <= 0) { // si tous les stacks sont sur la grille
      if (!this._engine.get_phase()) { //!this._engine.get_phase()
  ...
  _draw_move(i, j) {
    ...
    let color_possible_move = Board[i][j];      //remplissage d'un tableau -> chiffre de -1 a 7 autour du stack en fonction des coups possibles (-1 = coup impossible : 0 à 7 = direction)
