...
class Engine extends OpenXum.Engine {
    ...
    get_possible_move_list(x,y) {                            // liste tout les mouvements jouables
        let possible_move = [];                              // liste qui stock les mouvemennts jouables
        let i = 0;                                           // sert à savoir la place dans le tableau
        ...
        if (x>0) {                                           // si le stack n'est pas collé au bord
            move_range = Board[x-1][y];                      // recupere le chiffre du plateau qui indique le mouvement au nord
        ...
        if (x>0&&y<12) {                                     // si le stack n'est pas sur le bord nord ou est
            move_range = Board[x-1][y+1];                    // recupere le chiffre du plateau qui indique le mouvement au nord
            ...
            else{                                            // si le stack doit rebondire sur le bord
...
//TODO et gerer case particuliere
